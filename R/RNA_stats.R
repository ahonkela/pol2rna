DATAPATH <- '~/local/projects/synergy_rnaseq/'
...
par(mfrow=c(2, 1))
hist(log(mrnas,10), seq(-0.5, 7, by=0.5))
hist(log(premrnas,10), seq(-0.5, 7, by=0.5))
...
par(mfrow=c(2, 1))
hist(log(mrnacov,10), seq(-6, 3.5, by=0.5))
hist(log(premrnacov,10), seq(-6, 3.5, by=0.5))
