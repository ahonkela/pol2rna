...
pdf('delay_survival_ctd.pdf', width=87/25.4, height=50/25.4)
...
pdf('delay_survival_lenfiltered_ctd.pdf', width=130/25.4, height=50/25.4)
par(ps=FONTSIZE, cex=1)
...
pdf('delay_survival_devbounds_ctd.pdf', width=87/25.4, height=150/25.4)
par(ps=FONTSIZE, cex=1)
par(mar=c(1.3, 1.3, 0.7, 1.3)+0.4)
par(mgp=c(0.6, 0.1, 0))
par(mfrow=c(3, 2))
...
pdf('delay_survival_more_ctd.pdf', width=87/25.4, height=50/25.4)
par(ps=FONTSIZE, cex=1)
par(mar=c(1.0, 0.8, 0, 0.8)+0.4)
par(mgp=c(0.6, 0.1, 0))
par(mfrow=c(1, 2))
...
pdf('delay_survival_exonskip_ctd.pdf', width=87/25.4, height=50/25.4)
par(ps=FONTSIZE, cex=1)
par(mar=c(1.0, 0.8, 0, 0.8)+0.4)
par(mgp=c(0.6, 0.1, 0))
par(mfrow=c(1, 1))
...
pdf('delay_histogram_med_ctd.pdf', width=HISTWIDTH, height=HISTHEIGHT)
par(ps=FONTSIZE, cex=1)
...
pdf('delay_comparison_ctd.pdf', width=50/25.4, height=50/25.4)
par(mfrow=c(1, 1))
par(ps=FONTSIZE, cex=1)
par(mar=c(1.0, 0.8, 0, 0.8)+0.4)
par(mgp=c(0.6, 0.1, 0))
