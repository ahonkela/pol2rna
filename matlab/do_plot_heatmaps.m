function I_pcomb = do_plot_heatmaps(dataVals1, dataVals2, name, Iextra),
...
if nargin > 3,
  plot_with_order(dataVals1, dataVals2, Iextra);
  print('-depsc2', PRINTSTYLE, [name, '_heatmap_extrasort.eps']);
end

function plot_with_order(dataVals1, dataVals2, I)

assert(size(dataVals1, 2) == 101);
t_tick = [0, 20, 80, 160, 320, 640, 1280];
