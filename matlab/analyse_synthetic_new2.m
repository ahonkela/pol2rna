...
for i=1:prod(datasize(1:2)),
  ...
  fnames{k,l,1} = sprintf('Synthetic_%02d_samples_synth_new_2013-08-19a_unif0.mat', i);
  fnames{k,l,2} = sprintf('Synthetic_%02d_samples_synth_new_nodelay_2013-08-19a_unif0.mat', i);
  fnames{k,l,3} = sprintf('Synthetic_%02d_samples_synth_new_2013-08-26a_unif0.mat', i);
  fnames{k,l,4} = sprintf('Synthetic_%02d_samples_synth_new_nodelay_2013-08-26a_unif0.mat', i);
  fnames{k,l,5} = sprintf('Synthetic_%02d_samples_synth_new_2013-08-27b_data1_unif0.mat', i);
  fnames{k,l,6} = sprintf('Synthetic_%02d_samples_synth_new_nodelay_2013-08-27b_data1_unif0.mat', i);
  fnames{k,l,7} = sprintf('Synthetic_%02d_samples_synth_new_2013-08-27b_data2_unif0.mat', i);
  fnames{k,l,8} = sprintf('Synthetic_%02d_samples_synth_new_nodelay_2013-08-27b_data2_unif0.mat', i);
end
