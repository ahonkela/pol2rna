function [jointmodelb,jointtransforminfo,pol2modelb,rnamodelb,naive_ll,rbf_ll,joint_ll]=createNdGeneGPModels(timevector,dataVals1,dataVals2,lengthscale,maxiters,ninits,parameterranges,use_fixedrnavariance);
...
for initializationtype=1:ninits,
  try
    ...
    [jointmodel,temptransforminfo]=createNdSimDisim(timevector,dataVals1,dataVals2,lengthscale,initializationtype,parameterranges,use_fixedrnavariance);
