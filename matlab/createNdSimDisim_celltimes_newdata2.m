function [gpsim3model,transforminfo]= ...
    createNdSimDisim_celltimes_newdata2(timevector,dataVals,lengthscale,initializationtype,parameterranges,use_fixedrnavariance,addPriors,rnavars);
