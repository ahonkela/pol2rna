mypaths = {'~/github/pol2rna/matlab/hmc_results/joint/', ...
%           '~/github/pol2rna/matlab/hmc_results/joint/', ...
          };
sdata = load('simulated_data_changingD.mat');
...
for i=1:prod(datasize(1:2)),
  ...
  fnames{k,l,1} = sprintf('Synthetic_1%02d_samples_synth_2015-05-19a_data1_unif0.mat', i);
  %  fnames{k,l,2} = sprintf('Synthetic_%02d_samples_synth_2014-10-21a_data2_unif0.mat', i);
  %  fnames{k,l,3} = sprintf('Synthetic_%02d_samples_synth_2014-10-21a_data3_unif0.mat', i);
end
...
delaymeans = cellfun(@(x) x(5), parammeans);
