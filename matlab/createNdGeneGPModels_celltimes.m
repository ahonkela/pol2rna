function [jointmodelb,jointtransforminfo,pol2modelb,rnamodelb,naive_ll,rbf_ll,joint_ll]=createNdGeneGPModels_celltimes(timevector,dataVals,lengthscale,maxiters,ninits,parameterranges,use_fixedrnavariance);
...
for initializationtype=1:ninits,
  %try
    ...
    [jointmodel,temptransforminfo]=createNdSimDisim_celltimes(timevector,dataVals,lengthscale,initializationtype,parameterranges,use_fixedrnavariance);
