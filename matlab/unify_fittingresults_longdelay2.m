...
for k=0:5:95,
  fitname=sprintf('fittingresults_shifted_longerdelay5_startpercent%d.mat',k);
  load(fitname);
  if k==0,
...
save allresults_shifted_longerdelay5.mat allresults_jointmodels allresults_jointtransforminfos allresults_loglikelihoods allresults_geneindices allresults_ensemblids -mat
